  ...
  return (
    <div className="tab-container">
      ...
      <style>{`
        ...
        .state-r { background: rgba(100, 255, 218, 0.2); color: var(--accent-cyan); }
        .state-s { background: rgba(136, 146, 176, 0.2); color: var(--text-secondary); }
        .state-d { background: rgba(247, 140, 108, 0.2); color: #f78c6c; }
        .state-z { background: rgba(255, 83, 112, 0.2); color: #ff5370; }
        .state-t { background: rgba(255, 203, 107, 0.2); color: #ffcb6b; }
        ...
        .disk-selector-btn:hover {
          border-color: var(--accent-cyan);
        }

        .disk-selector-btn.is-active {
          background: rgba(100, 255, 218, 0.15);
          border-color: var(--accent-cyan);
        }
